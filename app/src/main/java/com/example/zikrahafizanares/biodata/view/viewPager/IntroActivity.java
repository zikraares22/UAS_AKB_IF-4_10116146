package com.example.zikrahafizanares.biodata.view.viewPager;
...
import com.example.zikrahafizanares.biodata.R;
...
public class IntroActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* if (restorePrefData()) {
        ...
        mList.add(new ScreenItem("Welcome My Biodata","",R.drawable.white));
        mList.add(new ScreenItem("Features ","has 3 profile features, contacts, friends",R.drawable.white));
        mList.add(new ScreenItem("Let's Start","",R.drawable.white));
